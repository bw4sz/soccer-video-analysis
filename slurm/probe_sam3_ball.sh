...
#SBATCH --gpus=1
#SBATCH --output=/home/b.weinstein/logs/sv_sam3_ball_%j.out
#SBATCH --error=/home/b.weinstein/logs/sv_sam3_ball_%j.err
set -uo pipefail
...
echo "start: $(date)"
$PY -u "$REPO/slurm/probe_sam3_ball.py"
echo "done: $(date)"
