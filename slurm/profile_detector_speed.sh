...
#SBATCH --gpus=1
#SBATCH --output=/home/b.weinstein/logs/sv_speed_prof_%j.out
#SBATCH --error=/home/b.weinstein/logs/sv_speed_prof_%j.err
...
"$PY" slurm/profile_detector_speed.py \
