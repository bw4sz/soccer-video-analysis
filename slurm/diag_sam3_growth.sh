...
#SBATCH --gpus=1
#SBATCH --output=/home/b.weinstein/logs/sv_sam3_diag_%j.out
#SBATCH --error=/home/b.weinstein/logs/sv_sam3_diag_%j.err
set -uo pipefail
...
echo "start: $(date)"
$PY -u "$REPO/slurm/diag_sam3_growth.py"
echo "done: $(date)"
