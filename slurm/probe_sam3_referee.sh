...
#SBATCH --gpus=1
#SBATCH --output=/home/b.weinstein/logs/sv_sam3_ref_%j.out
#SBATCH --error=/home/b.weinstein/logs/sv_sam3_ref_%j.err
set -uo pipefail
...
echo "start: $(date)"
$PY -u "$REPO/slurm/probe_sam3_referee.py"
echo "done: $(date)"
