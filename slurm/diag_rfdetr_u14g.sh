#!/bin/bash
#SBATCH --job-name=sv_diag_rfdetr
...
#SBATCH --gpus=1
#SBATCH --output=/home/b.weinstein/logs/sv_diag_rfdetr_%j.out
#SBATCH --error=/home/b.weinstein/logs/sv_diag_rfdetr_%j.err
